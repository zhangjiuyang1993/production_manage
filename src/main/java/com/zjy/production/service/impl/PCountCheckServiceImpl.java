...
import com.zjy.production.domain.vo.ProcessCountCheckVO;
import com.zjy.production.mapper.ProcessCountCheckMapper;
...
public class PCountCheckServiceImpl implements PCountCheckService {
	...
	@Override
	public EUDataGridResult searchPCountCheckByPCountCheckId(int page, int rows, String pCountCheckId)
			throws Exception {
		//分页处理
		PageHelper.startPage(page, rows);
