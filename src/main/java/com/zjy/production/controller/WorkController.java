...
import com.zjy.production.service.WorkService;
...
public class WorkController {
    ...
    public List<Work> getData() throws Exception{
        List<Work> list = workService.find();
        return list;
    }
    ...
    @ResponseBody
    public CustomResult insert(@Valid Work work, BindingResult bindingResult) throws Exception{
        CustomResult result;
    ...
    @ResponseBody
    public CustomResult update(@Valid Work work,BindingResult bindingResult) throws Exception{
        if (bindingResult.hasErrors()){
            FieldError fieldError = bindingResult.getFieldError();
            return CustomResult.build(100,fieldError.getDefaultMessage());
        }
    ...
    @ResponseBody
    public CustomResult updateAll(@Valid Work work,BindingResult bindingResult) throws Exception{
        if (bindingResult.hasErrors()){
            FieldError fieldError = bindingResult.getFieldError();
            return CustomResult.build(100,fieldError.getDefaultMessage());
        }
    ...
    public EUDataGridResult searchWorkByWorkId(Integer page,Integer rows,String workId) throws Exception{
        EUDataGridResult result = workService.searchWorkByWorkId(page,rows,workId);
        return result;
    }
    ...
    public EUDataGridResult searchWorkByWorkProduct(Integer page,Integer rows,String workProduct) throws Exception{
        EUDataGridResult result = workService.searchWorkByWorkProduct(page,rows,workProduct);
        return result;
    }
    ...
    @ResponseBody
    public EUDataGridResult searchWorkByWorkDevice(Integer page,Integer rows,String wordDevice) throws Exception{
        EUDataGridResult result = workService.searchWorkByWorkDevice(page,rows,wordDevice);
        return result;
    }
    ...
    public EUDataGridResult searchWorkByWorkProcess(Integer page,Integer rows,String workProcess) throws Exception{
        EUDataGridResult result = workService.searchWorkByWorkProcess(page,rows,workProcess);
        return result;
    }
}
