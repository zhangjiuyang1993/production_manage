...
public class DepartmentController {
	...
	@ResponseBody
	public EUDataGridResult searchDepartmentByDepartmentId(Integer page,Integer rows,String searchValue) throws Exception{
	...
	@ResponseBody
	public EUDataGridResult searchDepartmentByDepartmentByDepartmentName(Integer page,Integer rows,String searchValue) throws Exception{
