...
import com.zjy.production.service.DeviceCheckService;
...
public class DeviceCheckController {
	...
	private CustomResult insert(@Valid DeviceCheck deviceCheck,BindingResult bindingResult) throws Exception{
		...
		if(deviceCheckService.get(deviceCheck.getDeviceCheckId()) != null){
			result = new CustomResult(1,"该设备例检编号已经存在，请更换设备例检编号！",null);
		}else{
	...
	@ResponseBody
	public EUDataGridResult searchDeviceCheckByDeviceCheckId(Integer page,Integer rows,String searchValue) throws Exception{
	...
	@ResponseBody
	public EUDataGridResult searchDeviceCheckByDeviceName(Integer page,Integer rows,String searchValue) throws Exception{
